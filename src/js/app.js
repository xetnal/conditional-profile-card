...
function render(variables = {}) {
  ...
  if (variables.twitter === null) variables.twitter = "Not specified";
  if (variables.github === null) variables.github = "Not specified";
  if (variables.linkedin === null) variables.linkedin = "Not specified";
  if (variables.instagram === null) variables.instagram = "Not specified";
...
window.onload = function() {
  window.variables = {
    ...
    avatarURL: "https://i.ibb.co/wSyJsnn/foto-3.jpg",
